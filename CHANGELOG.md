...
|  |     This package was originally included at Autoware 1.10.0 and has remained unchanged.
│  | 
...
│  		* ndt_mapping: Doesn't include GPU support for NDT
│  		* ndt_matching:  Doesn't include GPU support for NDT. Publishing predict_pose_error 
|			(the difference between ndt_pose and predict_pose)
│ 
└───mapping
|   └───map_tf_generator: This package was originally included at Autoware 1.10.0 and has remained unchanged.
|   |     
|   └───pcd_loader: Originally included in Autoware.ai 1.10.0 under package /map_file. Changes made:
|		* Doesn't include support for vector maps. Project Aslan is tested and proven stable with point cloud maps only.
| 
└───planning
...
│       │         * [Feature] Calibration for deceleration and search distance after on-vehicle testing 
...
│       │     * twist_gate: Doesn't include support for mode and gear command
│       │     * Fixed warning messages when building
│       │     
|       └───waypoint_maker: Originally included in Autoware.ai 1.10.0. Changes made:
│             * waypoint_marker_publisher: Doesn't include support for traffic lights
│             * Fixed warning messages when building
