...
static void param_callback(const aslan_msgs::ConfigNDTMapping::ConstPtr& input)
{
    ...
    std::cout << "param_callback ndt_mapping" << std::endl;
...
static void output_callback(const aslan_msgs::ConfigNDTMappingOutput::ConstPtr& input)
{
