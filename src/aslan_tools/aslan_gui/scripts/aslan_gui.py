...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.1 on Wed Jun 24 10:59:07 2020
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.radio_box_1 = wx.RadioBox(self.tab_configuration, wx.ID_ANY, _("Vehicle Model"), choices=[_("Twizy URDF"), _("eNV200 URDF")], majorDimension=2, style=wx.RA_SPECIFY_COLS)
		self.button_vehicle_model = wx.ToggleButton(self.tab_configuration, wx.ID_ANY, _("Visualization"))
		self.panel_2_copy_2 = wx.Panel(self.tab_configuration, wx.ID_ANY)
		self.button_vehicle_model_readme = wx.ToggleButton(self.tab_configuration, wx.ID_ANY, _("?"))
		...
		self.radio_box_ins = wx.RadioBox(self.tab_controls, wx.ID_ANY, _("GPS/IMU"), choices=[_("OXTS INS"), _("PCAN-GPS"), _("None")], majorDimension=2, style=wx.RA_SPECIFY_ROWS)
		self.button_vehicle_interface_readme = wx.ToggleButton(self.tab_controls, wx.ID_ANY, _("?"))
		self.radio_box_speed_input = wx.RadioBox(self.tab_controls, wx.ID_ANY, _("Speed Input"), choices=[_("Vehicle CAN"), _("GPS Speed"), _("Localization")], majorDimension=2, style=wx.RA_SPECIFY_ROWS)
		self.radio_box_run = wx.RadioBox(self.tab_controls, wx.ID_ANY, _("Mode"), choices=[_("Vehicle"), _("Gazebo Simulation")], majorDimension=2, style=wx.RA_SPECIFY_ROWS)
		...
		self.bitmap_2 = wx.StaticBitmap(self.tab_simulation, wx.ID_ANY, wx.NullBitmap)
		...
		self.Bind(wx.EVT_TOGGLEBUTTON, self.OnInfoVM, self.button_vehicle_model_readme)
	...
	def __set_properties(self):
		...
		self.button_vehicle_model_readme.SetMinSize((26, 26))
		self.button_vehicle_model_readme.SetForegroundColour(wx.Colour(35, 142, 35))
		...
		self.radio_box_ins.SetMinSize((230, 68))
		...
		self.radio_box_speed_input.SetMinSize((230, 68))
		self.radio_box_speed_input.SetSelection(1)
		self.radio_box_run.SetMinSize((230, 68))
	...
	def __do_layout(self):
		...
		sizer_4_copy.Add(self.radio_box_1, 1, 0, 0)
		sizer_17.Add(self.button_vehicle_model, 0, wx.ALIGN_CENTER | wx.ALL, 4)
		sizer_17.Add(self.panel_2_copy_2, 1, wx.EXPAND, 0)
		sizer_4_copy.Add(sizer_17, 1, wx.ALL | wx.EXPAND, 0)
		sizer_4_copy.Add(self.button_vehicle_model_readme, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 0)
		sizer_46.Add(sizer_4_copy, 0, wx.EXPAND, 0)
		sizer_46.Add((20, 15), 0, wx.EXPAND, 0)
		sizer_19.Add(self.panel_sensing, 4, wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, 0)
		sizer_19.Add(self.panel_sensing2, 2, wx.ALIGN_BOTTOM | wx.EXPAND, 0)
		...
		sizer_3.Add(self.bitmap_2, 0, 0, 0)
	...
	def OnInfoVM(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnInfoVM' not implemented!"
		event.Skip()
